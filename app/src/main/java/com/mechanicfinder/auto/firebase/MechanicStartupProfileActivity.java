...
public class MechanicStartupProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechanic_startup_profile);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    finish();
                    Intent moveToHome = new Intent(MechanicStartupProfileActivity.this, MechanicMainActivity.class);
    ...
    private void profilePhotoSelection() {
        ...
        final CharSequence[] items = {"Take a Picture", "Choose Photo from Library",
                "Cancel"};
        AlertDialog.Builder builder = new AlertDialog.Builder(MechanicStartupProfileActivity.this);
            ...
            if (imageHoldUri != null)
            {
                ...
                mChildStorage.putFile(imageHoldUri).addOnSuccessListener( new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Picasso.with(MechanicStartupProfileActivity.this).load(imageUrl).into(profilePhoto);
                        mProgress.dismiss();
                ...
                Toast.makeText(MechanicStartupProfileActivity.this, "Please select a profile photo", Toast.LENGTH_LONG).show();
            }
        }

        else{
            Toast.makeText(MechanicStartupProfileActivity.this, "Please fill up all of the required fields", Toast.LENGTH_LONG).show();
        }

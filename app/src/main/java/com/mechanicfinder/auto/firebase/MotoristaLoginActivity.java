...
public class MotoristaLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(auth.getCurrentUser()!= null){
            startActivity(new Intent(MotoristaLoginActivity.this, MotoristaMainActivity.class));
            finish();
        }
        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MotoristaLoginActivity.this,SignUpTypeActivity.class));
            }
        });
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MotoristaLoginActivity.this,ResetPasswordActivity.class));
            }
        });
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(!task.isSuccessful()){
                            ...
                            if(password.length()<6){
                                ...
                                Toast.makeText(MotoristaLoginActivity.this,getString(R.string.auth_failed),Toast.LENGTH_LONG).show();
                            }
                        }else {

...
public class MotoristaStartupProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_motorista_startup_profile);
    ...
    private void profilePhotoSelection() {
        ...
        final CharSequence[] items = {"Take a Picture", "Choose Photo from Library",
                "Cancel"};
        AlertDialog.Builder builder = new AlertDialog.Builder(MotoristaStartupProfileActivity.this);
            ...
            if (imageHoldUri != null)
            {
                ...
                mChildStorage.putFile(imageHoldUri).addOnSuccessListener( new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Picasso.with(MotoristaStartupProfileActivity.this).load(imageUrl).into(profilePhoto);
                        mProgress.dismiss();
                ...
                Toast.makeText(MotoristaStartupProfileActivity.this, "Please select a profile photo", Toast.LENGTH_LONG).show();
            }
        }

        else{
            Toast.makeText(MotoristaStartupProfileActivity.this, "Please fill up all of the required fields", Toast.LENGTH_LONG).show();
        }

    ...
    private void saveUserProfile(){
        ...
        if (!TextUtils.isEmpty(firstname) && !TextUtils.isEmpty(surname) && !TextUtils.isEmpty(contactNumber) && !TextUtils.isEmpty(emailAddress))
        {
            if (imageHoldUri != null)
            {
                ...
                mChildStorage.putFile(imageHoldUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        final Uri imageUrl = taskSnapshot.getDownloadUrl();
                            ...
                            Picasso.with(UserProfileActivity.this).load(imageUrl).into(profilePhoto);
                            mProgress.dismiss();
                ...
                Toast.makeText(UserProfileActivity.this, "Please select a profile photo", Toast.LENGTH_LONG).show();
            }
        }

        else{
            Toast.makeText(UserProfileActivity.this, "Please fill up all of the required fields", Toast.LENGTH_LONG).show();
        }

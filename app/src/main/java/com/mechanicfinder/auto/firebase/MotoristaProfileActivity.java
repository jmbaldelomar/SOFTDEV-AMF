...
public class MotoristaProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    finish();
                    Intent moveToHome = new Intent(MotoristaProfileActivity.this, MotoristaMainActivity.class);
    ...
    private void profilePhotoSelection() {
        ...
        final CharSequence[] items = {"Take a Picture", "Choose Photo from Library",
                "Cancel"};
        AlertDialog.Builder builder = new AlertDialog.Builder(MotoristaProfileActivity.this);
            ...
            if (imageHoldUri != null)
            {
                ...
                mChildStorage.putFile(imageHoldUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Picasso.with(MotoristaProfileActivity.this).load(imageUrl).into(profilePhoto);
                        mProgress.dismiss();
                ...
                Toast.makeText(MotoristaProfileActivity.this, "Please select a profile photo", Toast.LENGTH_LONG).show();
            }
        }

        else{
            Toast.makeText(MotoristaProfileActivity.this, "Please fill up all of the required fields", Toast.LENGTH_LONG).show();
        }
